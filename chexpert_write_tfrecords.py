...
def write_tfrecord(input_file, output_dir,base_path):
    ...
    dataset['Image Index'] = dataset['Image Index'].apply(lambda x: os.path.join(base_path,x))
    img_addrs = dataset['Image Index'].values
    img_labels = dataset[dataset.columns[2:]].values
